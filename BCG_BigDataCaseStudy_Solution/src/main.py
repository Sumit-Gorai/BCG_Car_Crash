...
if __name__ == '__main__':
    ...
    try:
        ...
        print(f"Analysis 1 failed with error : {excep}")
    ...
    try:
        ...
        print(f"Analysis 2 failed with error : {excep}")
    ...
    try:
        ...
        print(f"Analysis 3 failed with error : {excep}")
    ...
    try: 
        ...
        print(f"Analysis 4 failed with error : {excep}")
    ...
    try:
        ...
        print(f"Analysis 5 failed with error : {excep}")
    ...
    try:
        ...
        print(f"Analysis 6 failed with error : {excep}")
    ...
    try:
        ...
        print(f"Analysis 7 failed with error : {excep}")
    ...
    try:
        ...
        print("Analysis 8 completed")
    except Exception as excep:
        print(f"Analysis 8 failed with error : {excep}")
    ...
    try:
        ...
        print("Analysis 9 completed")
    except Exception as excep:
        print(f"Analysis 9 failed with error : {excep}")
    ...
    try:
        ...
        print("Analysis 10 completed")
    except Exception as excep:
        print(f"Analysis 10 failed with error : {excep}")
